 ...
 *
 */
public class CourseSectionRemoveDto
{
    ...
    private CourseSectionRemoveDto(Builder builder)
    {
    ...
    public boolean equals(Object o) {
        ...
        CourseSectionRemoveDto that = (CourseSectionRemoveDto) o;
    ...
    public String toString() {
        return "CourseSectionRemoveDto{" +
                "CourseSectionId=" + CourseSectionId +
                '}';
    }

    /**
     * Creates builder to build {@link CourseSectionRemoveDto}.
    ...
    /**
     * Builder to build {@link CourseSectionRemoveDto}.
     */
    @Generated("SparkTools")
    public static final class Builder
    {
        ...
        public CourseSectionRemoveDto build()
        {
            return new CourseSectionRemoveDto(this);
        }
    }
}
