...
/**
 * Defines information for the facultyUnrequestCourse request including the keys for the
 * header, parameters, and body and the request type (RequestMethod).
 *
 * @author dselent
 *
 */
public class FacultyUnrequestCourse
{
    public static final RequestMethod REQUEST_TYPE = RequestMethod.POST;
    /* change this */
    public static final String REQUEST_NAME = "facultyUnrequestCourse";
    ...
    /* change this */
    private FacultyUnrequestCourse()
    {
