...
/**
 * Defines information for the locationRemove request including the keys for the
...
public class LocationRemove
{
    ...
    /* change this */
    public static final String REQUEST_NAME = "locationRemove";
