...
/**
 * Defines information for the adminChangeUserRole request including the keys for the
 * header, parameters, and body and the request type (RequestMethod).
 *
 * @author dselent
 *
 */
public class AdminChangeUserRole
{
    public static final RequestMethod REQUEST_TYPE = RequestMethod.POST;
    /* change this */
    public static final String REQUEST_NAME = "AdminChangeUserRole";
