...
/**
 * Defines information for the adminConfirmUser request including the keys for the
 * header, parameters, and body and the request type (RequestMethod).
 *
 * @author dselent
 *
 */
public class AdminConfirmUser
{
    public static final RequestMethod REQUEST_TYPE = RequestMethod.POST;
    /* change this */
    public static final String REQUEST_NAME = "adminConfirmUser";
