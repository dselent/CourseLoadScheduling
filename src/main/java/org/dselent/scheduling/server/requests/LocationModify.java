...
/**
 * Defines information for the locationModify request including the keys for the
...
public class LocationModify
{
    ...
    /* change this */
    public static final String REQUEST_NAME = "locationModify";
