...
/**
 * Defines information for the facultyRemove request including the keys for the
...
public class FacultyRemove
{
    ...
    /* change this */
    public static final String REQUEST_NAME = "facultyRemove";
