...
/**
 * Defines information for the departmentModify request including the keys for the
...
public class DepartmentModify
{
    ...
    /* change this */
    public static final String REQUEST_NAME = "departmentModify";
