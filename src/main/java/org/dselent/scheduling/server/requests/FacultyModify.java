...
/**
 * Defines information for the facultyModify request including the keys for the
...
public class FacultyModify
{
    ...
    /* change this */
    public static final String REQUEST_NAME = "facultyModify";
